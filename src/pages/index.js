...
const Index = ({ data }) => {
  ...
  return (
          ...
          <div className="spotlight">
            <div className="content">
              <header className="major">
                ...
                <h2>Closed for 20225! - Terra Farma pick-ups will continue on site! Pick up your order here at Funhouse (confirm pick-up date in advance). Funhouse Brews has officially ceased operation as a licensed brewery. </h2>
   ...
   <p>
                We are no longer operating as a licensed brewery. We had our best year in 2024, however, the regulatory environment is no longer suitable for home-based brewery operations. It's kind of crazy we were able to do this at all, when you think about it. For 2025, we will endeavor to serve the community with educational and small-scale not-for-profit homebrewing. Occasional informational sessions, lectures, and events will occur on Thursday evenings from 5-8 p.m. Funhouse Styles are handcrafted, unorthodox, “chimerical” crossbreeds of classic styles, with a focus on processes and ingredients impractical or impossible on a scale larger than 2 bbls.
                <br />
